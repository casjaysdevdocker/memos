...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202211201347-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  WTFPL
# @@ReadME           :  start-memos.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Nov 20, 2022 13:47 EST
# @@File             :  start-memos.sh
# @@Description      :  script to start memos
...
__heath_check() {
  ...
  #__pgrep ${1:-memos} &>/dev/null || healthStatus=$((healthStatus + 1))
...
HOSTNAME="${HOSTNAME:-casjaysdev-memos}"
...
[ -d "/data/memos" ] || mkdir -p "/data/memos"
[ -d "/var/opt/memos" ] && rm -Rf "/var/opt/memos"
ln -sf "/data/memos" "/var/opt/memos"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
