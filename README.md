...
```shell
dockermgr download src memos
```

OR

```shell
git clone "https://github.com/casjaysdevdocker/memos" "$HOME/Projects/github/casjaysdevdocker/memos"
```

## Build container  

```shell
cd "$HOME/Projects/github/casjaysdevdocker/memos"
buildx 
```
